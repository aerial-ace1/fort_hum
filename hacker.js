...
var p1_select = document.getElementById("shoot1");
var p1_submit = document.getElementById("shootp1");

var p2;
var p2_roll = document.getElementById("p2");
var p2_result = document.getElementById("p2v");
var p2_select = document.getElementById("shoot2");
var p2_submit = document.getElementById("shootp2");
...
function play1() {
  ...
  if (p1[roll] < 4) {
    ...
    fig.src = "5.png"
    p1_select.disabled = false;
    p1_submit.addEventListener("click", bang1);
  }
  count += 1;
  play();
}
